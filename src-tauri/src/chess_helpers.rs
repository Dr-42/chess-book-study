...
#[tauri::command]
pub fn get_attack_squares(fen: String, square: String) -> Vec<String> {
...
#[tauri::command]
pub fn check_board_state(fen: String) -> String {
    let board = Board::from_str(&fen).unwrap();
...
#[tauri::command]
pub fn get_king_square(fen: String, color: String) -> String {
    let board = Board::from_str(&fen).unwrap();
    let col = if color == "white" {
        chess::Color::White
    } else {
        chess::Color::Black
    };
...
#[tauri::command]
pub fn move_piece(fen: String, from: String, to: String, promotion: Option<String>) -> String {
    let board = Board::from_str(&fen).unwrap();
...
pub fn get_san_move(
    ...
    for m in moves {
        if m.get_dest() == mov.get_dest()
            && m.get_source() != mov.get_source()
...
#[tauri::command]
pub fn is_board_sane(fen: String) -> String {
